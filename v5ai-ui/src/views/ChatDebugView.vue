...
.composer { flex:none; padding:10px 14px 12px; border-top:1px solid var(--debug-divider); background:color-mix(in srgb,var(--debug-primary) 2%,var(--debug-surface)); } .composer :deep(.n-input) { background:var(--debug-embedded); } .composer-actions { display:flex; justify-content:flex-end; align-items:center; gap:8px; margin-top:8px; } .composer-hint { margin-top:7px; color:var(--debug-muted); font-size:11px; text-align:right; } .hidden-file-input { display:none; }
