...
public class PlmMenuController extends BaseController {
    ...
    @GetMapping("/list")
    public R<List<PlmMenuVo>> list(PlmMenuBo menu) {
        List<PlmMenuVo> menus = menuService.selectMenuList(menu, LoginHelper.getUserId());
        return R.ok(menus);
    }
    ...
    public R<PlmMenuVo> getInfo(@PathVariable Long menuId) {
    ...
    public R<List<Tree<Long>>> treeselect(PlmMenuBo menu) {
        List<PlmMenuVo> menus = menuService.selectMenuList(menu, LoginHelper.getUserId());
    ...
    public R<MenuTreeSelectVo> roleMenuTreeselect(@PathVariable("roleId") Long roleId) {
        List<PlmMenuVo> menus = menuService.selectMenuList(LoginHelper.getUserId());
    ...
    @RepeatSubmit()
    @PostMapping
    public R<Void> add(@Validated @RequestBody PlmMenuBo menu) {
    ...
    @RepeatSubmit()
    @PutMapping
    public R<Void> edit(@Validated @RequestBody PlmMenuBo menu) {
        if (!menuService.checkMenuNameUnique(menu)) {
    ...
    public R<Void> changeStatus(@RequestBody PlmMenuBo menu) {
        return toAjax(menuService.updateMenuStatus(menu.getId(), menu.getStatus()));
    }
