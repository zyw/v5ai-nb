package xin.v5ai.nb.common.translation.core.impl;

import cn.hutool.core.convert.Convert;
import lombok.AllArgsConstructor;
import xin.v5ai.nb.common.core.utils.StreamUtils;
import xin.v5ai.nb.common.translation.annotation.TranslationType;
import xin.v5ai.nb.common.translation.constant.TransConstant;
...
public class UserNameTranslationImpl implements TranslationInterface<String> {
    ...
    public Map<Object, String> translationBatch(Set<Object> keys, String other) {
        ...
        Map<Long, String> userNames = new LinkedHashMap<>(StreamUtils.toMap(userService.selectListByIds(userIds), UserDTO::getId, UserDTO::getUserName));
