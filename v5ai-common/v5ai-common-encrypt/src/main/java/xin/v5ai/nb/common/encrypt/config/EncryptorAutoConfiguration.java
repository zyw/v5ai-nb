...
import xin.v5ai.nb.common.encrypt.core.EncryptContextFactory;
import xin.v5ai.nb.common.encrypt.core.EncryptedFieldProcessor;
import xin.v5ai.nb.common.encrypt.core.EncryptorManager;
import xin.v5ai.nb.common.encrypt.enums.AlgorithmType;
import xin.v5ai.nb.common.encrypt.interceptor.MybatisDecryptInterceptor;
import xin.v5ai.nb.common.encrypt.interceptor.MybatisEncryptInterceptor;
import xin.v5ai.nb.common.encrypt.properties.EncryptorProperties;
...
@ConditionalOnProperty(value = "v5ai.mybatis-encryptor.enable", havingValue = "true")
@Slf4j
