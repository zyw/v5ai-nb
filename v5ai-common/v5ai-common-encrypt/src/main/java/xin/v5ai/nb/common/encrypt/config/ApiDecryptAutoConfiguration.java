...
import xin.v5ai.nb.common.encrypt.filter.CryptoFilter;
import xin.v5ai.nb.common.encrypt.properties.ApiDecryptProperties;
...
@ConditionalOnProperty(value = "v5ai.api-decrypt.enabled", havingValue = "true")
